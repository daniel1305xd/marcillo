...
public class videos {
    ...
    public videosemanales(JSONObject a) throws JSONException {
    ...
    public static ArrayList<videos> JsonObjectsBuild(JSONArray datos) throws JSONException {
        ArrayList<videos> productos = new ArrayList<>();

        for (int i = 0; i < datos.length() && i<20; i++) {
            productos.add(new videos(datos.getJSONObject(i)));
        }
        return productos;
    }
